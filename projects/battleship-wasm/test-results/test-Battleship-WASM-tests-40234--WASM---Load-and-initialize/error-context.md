...
- Name: test.spec.js >> Battleship WASM tests >> Battleship WASM - Load and initialize
- Location: test.spec.js:38:5
...
Call log:
  ...
  - waiting for locator('#player-board')
    9 × locator resolved to <div id="player-board"></div>
