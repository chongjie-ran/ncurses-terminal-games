...
- Name: test.spec.js >> Battleship WASM tests >> Battleship WASM - Auto place and enter battle
- Location: test.spec.js:53:5
...
Expected substring: "Battle"
Received string:    "🚢 Phase 1: Place Your Ships"
```
